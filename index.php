<?php
	session_start();
	//print_r($_SESSION);
	$name=isset($_SESSION['USR'])?$_SESSION['USR']:'';
?>
<!doctype html>
<html lang="en">
<head>
...
<body>
    ...
    <!-- 底部开始 -->
    <div class="footer">
        <div class="copyright">Copyright ©2018 CBW v2.0 All Rights Reserved</div>  
    </div>
    <!-- 底部结束 -->
    <script>
    //百度统计可去掉
